        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <Card>
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-primary">{bookmarks?.length || 0}</div>
                ...
                <Card>
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-primary">
                      {bookmarks?.reduce((sum, bookmark) => sum + bookmark.article.reactionsCount, 0) || 0}
                    </div>
                ...
                <Card>
                  <CardContent className="p-4 text-center">
                    <div className="text-2xl font-bold text-primary">
                      {bookmarks?.reduce((sum, bookmark) => sum + bookmark.article.commentsCount, 0) || 0}
                    </div>
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="outline">
                          ...
                          Sort: {sortBy === "recent" ? "Recent" : sortBy === "popular" ? "Popular" : "Title"}
